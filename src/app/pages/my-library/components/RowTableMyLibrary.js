...
export default function RowTableMyLibrary(props){
    ...
    return(
        <div className="flex row_table px-8 py-8" >
            ...
            <DeleteGame currentPage={currentPage} gameId={gameId} handleRefresh={props.handleRefresh} gameName={ rowData.gameDetails !== undefined ? rowData.gameDetails.gameName : ""}/>
        </div>
    )
}
